...
public class Yolo2ImageClassifier {
    ...
    public List<DetectedObject> detect(String inputImagePath, String outputImagePath) throws IOException {
    ...
    public void detectObjects(String name, String srcPath, String destPath)
        throws IOException
    {
        System.out.println("FileName:" + name);

        List<DetectedObject> detectedObjects = detect(srcPath, destPath);
        System.out.println("Detected Objects Size:" + detectedObjects.size());
        for(DetectedObject detectedObject : detectedObjects)
        {
            System.out.println(labels.getLabel(detectedObject.getPredictedClass()));
        }
    }
    ...
    public static void main(String[] args)
        throws IOException
    {
        Yolo2ImageClassifier imageClassifier = new Yolo2ImageClassifier();

        imageClassifier.detectObjects("KnifeAdFork.jpg", "/Users/b.rajkumar/workspace/deeplearning4j-examples/dl4j-examples/src/main/resources/KnifeAndFork.jpg", "/Users/b.rajkumar/workspace/deeplearning4j-examples/dl4j-examples/src/main/resources/KnifeAndFork_output.jpg");
        imageClassifier.detectObjects("knife_from_office.jpg", "/Users/b.rajkumar/workspace/deeplearning4j-examples/dl4j-examples/src/main/resources/knife_from_office.jpg", "/Users/b.rajkumar/workspace/deeplearning4j-examples/dl4j-examples/src/main/resources/knife_from_office_output.jpg");
        imageClassifier.detectObjects("knife_in_kitchen.jpg","/Users/b.rajkumar/workspace/deeplearning4j-examples/dl4j-examples/src/main/resources/knife_in_kitchen.jpg", "/Users/b.rajkumar/workspace/deeplearning4j-examples/dl4j-examples/src/main/resources/knife_in_kitchen_output.jpg");
        imageClassifier.detectObjects("knife_in_table.jpg","/Users/b.rajkumar/workspace/deeplearning4j-examples/dl4j-examples/src/main/resources/knife_in_table.jpg", "/Users/b.rajkumar/workspace/deeplearning4j-examples/dl4j-examples/src/main/resources/knife_in_table_output.jpg");
...
/*
https://github.com/monocongo/openimages#download-images-and-annotations
https://storage.googleapis.com/openimages/web/visualizer/index.html?type=detection&set=valtest&c=%2Fm%2F083kb
https://www.rcp-vision.com/objects-detection-with-yolo-technique-using-deeplearning4j/?lang=en
